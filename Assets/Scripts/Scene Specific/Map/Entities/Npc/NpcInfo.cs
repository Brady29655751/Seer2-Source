...
public class NpcInfo
{
    ...
    public Task<Sprite> icon => GetIcon(resId);
    ...
    public static async Task<Sprite> GetIcon(string resId) {
        if (int.TryParse(resId, out _))
            return await Addressables.LoadAssetAsync<Sprite>("Npc/icon/" + resId).Task;
